...
public class Student_info extends JFrame {
	...
	public Student_info() {
		...
		nameList = new ArrayList<String>(); nameList.add("Akshat");nameList.add("Harshita");nameList.add("Sakshi"); nameList.add("Manish");
		passList = new ArrayList<String>();  passList.add("abcabc"); passList.add("abcabc"); passList.add("abcabc"); passList.add("abcabc");
		idList = new ArrayList<String>(); idList.add("iit2020505"); idList.add("iit2020021");idList.add("iit2020037"); idList.add("iib202030");
